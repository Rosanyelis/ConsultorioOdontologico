                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title">Examen IntraOral</h3>
                                ...
                                <div class="nk-block">
                                    <div class="card card-bordered">
                                        <div class="card-inner-group">
                                            <form id="form" action="{{ route('patient.store-examen-intraoral', $data->id) }}" method="POST">
                                                @csrf
                                                        ...
                                                        <div class="row gy-4 pb-4">
                                                            <div class="col-xxl-3 col-xl-3 col-md-3">
                                                                <div class="form-group">
                                                                    <label class="form-label" for="cheeks">Carrillos</label>
                                                                    <div class="form-control-wrap">
                                                                        <input type="text" name="cheeks" class="form-control"
                                                                            id="cheeks" >
                                                                        @if ($errors->has('cheeks'))
                                                            ...
                                                            <div class="col-xxl-3 col-xl-3 col-md-3">
                                                                <div class="form-group">
                                                                    <label class="form-label" for="mucous_membranes">Mucosa</label>
                                                                    <div class="form-control-wrap">
                                                                        <input type="text" name="mucous_membranes" class="form-control"
                                                                            id="mucous_membranes" >
                                                                        @if ($errors->has('mucous_membranes'))
                                                                            <span class="invalid text-danger">
                                                                                {{ $errors->first('mucous_membranes') }}
                                                                            </span>
                                                                        @endif
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="col-xxl-3 col-xl-3 col-md-3">
                                                                <div class="form-group">
                                                                    <label class="form-label" for="gums">Encia</label>
                                                                    <div class="form-control-wrap">
                                                                        <input type="text" name="gums" class="form-control"
                                                                            id="gums" >
                                                                        @if ($errors->has('gums'))
                                                                            <span class="invalid text-danger">
                                                                                {{ $errors->first('gums') }}
                                                            ...
                                                            <div class="col-xxl-3 col-xl-3 col-md-3">
                                                                <div class="form-group">
                                                                    <label class="form-label" for="language">Lengua</label>
                                                                    <div class="form-control-wrap">
                                                            ...
                                                            <div class="col-xxl-3 col-xl-3 col-md-3">
                                                                <div class="form-group">
                                                                    <label class="form-label" for="palate">Paladar</label>
                                                                    <div class="form-control-wrap">
                                                                        <input type="text" name="palate" class="form-control"
                                                                            id="palate" >
                                                                        @if ($errors->has('palate'))
                                                                            <span class="invalid text-danger">
                                                                                {{ $errors->first('palate') }}
                                                                            </span>
                                                                        @endif
                                                            ...
                                                            <div class="col-xxl-3 col-xl-3 col-md-3">
                                                                <div class="form-group">
                                                                    <label class="form-label" for="torus">Torus</label>
                                                                    <div class="form-control-wrap">
                                                                        <input type="text" name="torus" class="form-control"
                                                                            id="torus" >
                                                                        @if ($errors->has('torus'))
                                                                            <span class="invalid text-danger">
                                                                                {{ $errors->first('torus') }}
                                                            ...
                                                            <div class="col-xxl-3 col-xl-3 col-md-3">
                                                                <div class="form-group">
                                                                    <label class="form-label" for="aftas">Aftas</label>
                                                                    <div class="form-control-wrap">
                                                                        <input type="text" name="aftas" class="form-control"
                                                                            id="aftas" >
                                                                        @if ($errors->has('aftas'))
                                                                            <span class="invalid text-danger">
                                                                                {{ $errors->first('aftas') }}
                                                            ...
                                                            <div class="col-xxl-3 col-xl-3 col-md-3">
                                                                <div class="form-group">
                                                                    <label class="form-label" for="supragingival_tartar">Sarro Supragingival</label>
                                                                    <div class="form-control-wrap">
                                                                        <input type="text" name="supragingival_tartar" class="form-control"
                                                                            id="supragingival_tartar" >
                                                                        @if ($errors->has('supragingival_tartar'))
                                                                            <span class="invalid text-danger">
                                                                                {{ $errors->first('supragingival_tartar') }}
                                                                            </span>
                                                                        @endif
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="col-xxl-3 col-xl-3 col-md-3">
                                                                <div class="form-group">
                                                                    <label class="form-label" for="subgingival">Subgingival</label>
                                                                    <div class="form-control-wrap">
                                                                        <input type="text" name="subgingival" class="form-control"
                                                                            id="subgingival" >
                                                                        @if ($errors->has('subgingival'))
                                                                            <span class="invalid text-danger">
                                                                                {{ $errors->first('subgingival') }}
                                                                            </span>
                                                                        @endif
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="col-xxl-3 col-xl-3 col-md-3">
                                                                <div class="form-group">
                                                                    <label class="form-label" for="crowding">Apiñamiento</label>
                                                                    <div class="form-control-wrap">
                                                                        <input type="text" name="crowding" class="form-control"
                                                                            id="crowding" >
                                                                        @if ($errors->has('crowding'))
                                                                            <span class="invalid text-danger">
                                                                                {{ $errors->first('crowding') }}
                                                                            </span>
                                                                        @endif
                                                                    </div>
                                                                </div>
                                                ...
                                                <div class="col-12 mt-3 mb-3 text-right">
                                                    <div class="form-group">
                                                        <button id="guardar" type="button" class="btn btn-primary">Guardar Examen</button>
                                                    </div>
                                                </div>
                                                <!--col-->
                                            </form>
