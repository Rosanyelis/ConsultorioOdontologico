                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title">Plan de Tratamiento</h3>
                                ...
                                <div class="nk-block">
                                    <div class="card card-bordered">
                                        <div class="card-inner-group">
                                            <form id="form" action="{{ route('patient.store-treatment-plan', $data->id) }}" method="POST">
                                                @csrf
                                                    ...
                                                    <div class="nk-block">
                                                        <div class="row gy-4">
                                                            <div class="col-xxl-12 col-md-12">
                                                                <p>Nota: Solo seleccione el tipo de tratamiento y el conteo total se registrara en el sistema</p>
                                                            ...
                                                            <div class="col-xxl-12 col-xl-12 col-md-12">
                                                                <div class="form-group">
                                                                    <label class="form-label" for="other_treatments">Otros tratamiento</label>
                                                                    <div class="form-control-wrap">
                                                                        <textarea name="other_treatments" class="form-control" id="" cols="30" rows="3"></textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="col-12 mt-3 mb-3 text-right">
                                                    <div class="form-group">
                                                        <button id="guardar" type="button" class="btn btn-primary">Guardar Plan</button>
                                                    </div>
                                                </div>
                                                <!--col-->
                                            </form>
