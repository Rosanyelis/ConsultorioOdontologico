...
@section('content')
                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title">Instrucciones de toma de Medicamentos</h3>
                                            ...
                                            <ul class="nk-block-tools g-3">
                                                <li class="nk-block-tools-opt">
                                                    ...
                                                    <a href="javascript:void(0);" class="btn btn-primary d-none d-md-inline-flex"
                                                        data-toggle="modal" data-target="#modalCreate">
                                                        <em class="icon ni ni-plus"></em><span>Agregar Instrucciones</span></a>
                                                </li>
                                            </ul>
                                        </div><!-- .nk-block-head-content -->
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <ul class="link-list-opt no-bdr">
                                                                        <li>
                                                                            ...
                                                                            <form id="formDelete-{{ $item->id }}" action="{{ route('medication-instruction.destroy', ['id' => $item->id]) }}"method="POST">
                                                                                @csrf
                                                                            </form>
                                                                        </li>
                                                                    </ul>
                        ...
                        <!-- end page title -->
                        @include('medication_instruction.partials.modal-create')
@endsection

@section('scripts')
    <script src="{{ asset('pagejs/medicine.js') }}"></script>
@endsection
