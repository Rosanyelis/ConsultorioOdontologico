                            ...
                            <div class="nk-content-body">
                                ...
                                <div class="card card-preview">
                                    <div class="card-inner">
                                        <form class="row gy-2 form-validate" action="{{ route('user.update', $data->id) }}" method="POST">
                                            @csrf
                                            @method('PUT')
                                            <div class="col-4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <select class="form-select" name="rol_id" data-placeholder="Seleccione un rol">
                                                            ...
                                                            <option value="{{ $item->id }}" @if ($data->rol_id == $item->id)  selected @endif>{{ $item->name }}</option>
                                                            @endforeach
                                                        </select>
